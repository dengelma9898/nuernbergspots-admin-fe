...
import { useTaxiStandManagement } from '@/hooks/useTaxiStandManagement';
import { TaxiStandCard, TaxiStandCardMobile } from '@/components/taxi-stands/TaxiStandCards';
import {
  TaxiStandCardSkeleton,
  TaxiStandMobileSkeleton,
} from '@/components/taxi-stands/TaxiStandSkeletons';
import {
  ArrowLeft,
  Plus,
  Search,
...
export function TaxiStandManagementContent() {
  const {
    navigate,
    searchQuery,
    setSearchQuery,
