...
import { useEventCategoryList, convertFFToHex } from '@/hooks/useEventCategoryList';

export type EventCategoryListContentProps = ReturnType<typeof useEventCategoryList>;

export function EventCategoryListContent(props: EventCategoryListContentProps) {
  const {
    categories,
    setCategories,
    isDialogOpen,
      ...
      <div className="relative z-10 container mx-auto py-6">
        ...
        {isLoading ? (
          ...
          <motion.div
            ...
            transition={defaultTransition}
          >
            <Card className={cn(cardPreset, 'block md:hidden p-8 md:p-12 text-center')}>
