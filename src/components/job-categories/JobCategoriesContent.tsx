...
function JobCategoryTableSkeleton() {
  return (
    <Card className={cn(cardPreset, 'hidden md:block overflow-hidden')}>
      <Table>
        <TableHeader>
...
import { useJobCategories, convertFFToHex } from '@/hooks/useJobCategories';

export type JobCategoriesContentProps = ReturnType<typeof useJobCategories>;

export function JobCategoriesContent(props: JobCategoriesContentProps) {
  const {
    categories,
    setCategories,
    isDialogOpen,
      ...
      <div className="container mx-auto p-8 max-w-7xl relative z-10">
        ...
        {isLoading ? (
          ...
          <motion.div variants={fadeInUp} initial="initial" animate="animate">
            <Card className={cn(cardPreset, 'block md:hidden p-8 text-center')}>
                        ...
                        <TableCell>
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <LoadingButton variant="ghost" className="h-8 w-8 p-0 rounded-lg">
        ...
        >
          <DialogContent className={cn(cardPreset, 'max-w-4xl')}>
            <DialogHeader>
