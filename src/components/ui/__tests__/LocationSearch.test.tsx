...
jest.mock('lucide-react', () => ({
  ...
  MapPin: React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    (props, ref) => (
  ...
  Loader2: React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    (props, ref) => (
  ...
  X: React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
    (props, ref) => (
...
describe('LocationSearch Component', () => {
  ...
  describe('Error Handling', () => {
    it('sollte API-Fehler graceful handhaben', async () => {
      ...
      await waitFor(() => {
        expect(consoleErrorSpy).toHaveBeenCalledWith('Fehler bei der Adresssuche:', expect.any(Error));
      });
