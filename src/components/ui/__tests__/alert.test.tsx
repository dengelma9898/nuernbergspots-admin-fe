...
describe('Alert Komponente', () => {
  ...
  describe('Alert Komposition', () => {
    ...
    it('sollte nur mit Description funktionieren', () => {
      render(
        <Alert data-testid="alert">
          <AlertDescription data-testid="alert-description">Simple message</AlertDescription>
        </Alert>
      );
    ...
    it('sollte mit Icon funktionieren', () => {
      render(
        <Alert data-testid="alert">
          ...
          <AlertDescription data-testid="alert-description">Check your input</AlertDescription>
        </Alert>
      );
    ...
    it('sollte aria-describedby unterstützen', () => {
      render(
        <Alert aria-describedby="error-description" data-testid="alert">
          <AlertTitle>Error</AlertTitle>
          <AlertDescription id="error-description">Detailed error message</AlertDescription>
        </Alert>
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('sollte mit komplexen className-Kombinationen umgehen', () => {
      render(
        <Alert className="custom-1 custom-2 bg-red-500 text-white border-2" data-testid="alert">
