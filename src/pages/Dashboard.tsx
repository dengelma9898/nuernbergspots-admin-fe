...
import { cardPreset, cardPresetHover, badgePreset, buttonPreset } from '@/lib/designTokens';
      ...
      >
        ...
        >
          ...
          {pendingApprovalsLoading ? (
            ...
            pendingApprovals > 0 && (
              <AnimatedCard index={0} className={cn(cardPresetHover, 'p-4')}>
                <CardContent className="p-0">
                  {/* Header with icon and title in one line */}
                  <div className="flex items-center gap-2 mb-3">
          ...
          {usersInReviewLoading ? (
            ...
            usersInReview > 0 && (
              <AnimatedCard index={1} className={cn(cardPresetHover, 'p-4')}>
                <CardContent className="p-0">
                  {/* Header with icon and title in one line */}
                  <div className="flex items-center gap-2 mb-3">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-xl sm:text-2xl">{usersInReview > 10 ? '🔥' : '👤'}</div>
                    </div>
          ...
          {contactRequestsLoading ? (
            ...
            <AnimatedCard index={2} className={cn(cardPresetHover, 'p-4')}>
              <CardContent className="p-0">
                {/* Header with icon and title in one line */}
                <div className="flex items-center gap-2 mb-3">
          ...
          {totalUsersLoading ? (
            ...
            <AnimatedCard index={3} className={cn(cardPresetHover, 'p-4')}>
              <CardContent className="p-0">
                {/* Header with icon and title in one line */}
                <div className="flex items-center gap-2 mb-3">
