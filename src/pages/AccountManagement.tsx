  ...
  return (
    <div className="container mx-auto p-8 max-w-7xl">
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            <div className="text-center py-4">Lade Statistiken...</div>
          ) : stats ? (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
                  ...
                  <div>
                    <div className="text-sm text-muted-foreground">Älter als 5 Tage</div>
                    <div className="text-2xl font-bold">{stats.oldAccounts}</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
                  <Calendar className="h-8 w-8 text-muted-foreground" />
                  <div>
                    <div className="text-sm text-muted-foreground">Alle Accounts älter als</div>
