  ...
  const MessageBubble = ({ message }: { message: ContactMessage }) => {
    ...
    return (
      <div className={`flex ${isAdmin ? 'justify-end' : 'justify-start'} mb-6`}>
        <div className={`max-w-[85%] sm:max-w-[70%] rounded-2xl p-4 shadow-lg ring-1 ${
          isAdmin 
          ...
          <p className="text-sm md:text-base leading-relaxed text-white/90 mb-3">{message.message}</p>
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 p-4 md:p-8">
          <div className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 p-8 md:p-12 text-center max-w-lg mx-auto">
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-white mb-2">Kontaktanfrage nicht gefunden</h3>
