            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <Input
                      ...
                      className={cn(
                        glassInput,
                        'pl-12 pr-4 py-3',
                        hasError && 'border-destructive/50 focus:border-destructive/70 focus:ring-destructive/20'
                      )}
                    />
                  </motion.div>
                ...
                {isLoading && (
                  ...
                  >
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <span className="text-muted-foreground font-medium">Anmeldung läuft...</span>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              >
                <AnimatedButton
                  type="submit"
                  disabled={isLoading}
                  className={cn(glassButton, 'w-full py-3 font-medium text-base disabled:opacity-50')}
                >
                  {isLoading ? (
