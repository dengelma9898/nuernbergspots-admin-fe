          ...
          <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-6">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 overflow-hidden"
                >
                      ...
                      <div className="border-t border-white/10 pt-4">
                        ...
                        <div className="space-y-2">
                          {[...Array(2)].map((_, j) => (
                            <div
                              key={j}
                              className="flex items-center backdrop-blur-2xl bg-white/10 border border-white/20 p-3 rounded-xl"
                            >
                              <Skeleton className="h-8 w-8 bg-white/10 backdrop-blur-xl rounded-lg mr-3" />
        ...
        <div className="space-y-6 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6">
            {users.map(user => (
              <div
                key={user.id}
                className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 hover:shadow-3xl hover:scale-105 transition-all duration-500 overflow-hidden"
                data-slot="card"
              >
                <div className="p-4 sm:p-6">
                  {/* Header */}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 min-w-0 text-right">
                        <div className="flex items-center text-sm justify-end">
                          <span
                            className={`${user.isDeleted ? 'text-red-300' : 'text-green-300'} font-medium`}
                          >
                      ...
                      <div className="border-t border-white/10 pt-4">
                        ...
                        <div className="space-y-2">
                          {user.businessNames.map(name => (
                            <div
                              key={name}
                              className="flex items-center text-sm backdrop-blur-2xl bg-white/10 border border-white/20 p-3 rounded-xl break-all truncate max-w-full"
                            >
                              <div className="backdrop-blur-2xl bg-white/10 rounded-lg p-2 mr-3">
                    ...
                    <div className="w-full sm:w-auto">
                      <Button
                        ...
                        style={{
                          backdropFilter: 'blur(8px)',
                          background:
                            'linear-gradient(to right, rgba(34, 197, 94, 0.8), rgba(16, 185, 129, 0.8))',
                        ...
                        onMouseEnter={e => {
                          e.currentTarget.style.background =
                            'linear-gradient(to right, rgba(22, 163, 74, 0.9), rgba(5, 150, 105, 0.9))';
                          e.currentTarget.style.transform = 'scale(1.05)';
                        }}
                        onMouseLeave={e => {
                          e.currentTarget.style.background =
          ...
          {users.length === 0 && (
            <div className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 p-8 text-center">
              <div className="text-white/80">Keine Benutzer zur Überprüfung gefunden.</div>
            </div>
          )}
        </div>
      </div>
