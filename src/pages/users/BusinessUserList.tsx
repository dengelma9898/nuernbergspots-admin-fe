        ...
        <div className="relative z-10 min-h-screen bg-muted !bg-transparent px-4 py-6 sm:px-8 overflow-x-hidden">
          ...
          <div className="block md:hidden space-y-4 max-w-4xl mx-auto">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 p-4 w-full"
              >
                {/* E-Mail Skeleton */}
                <div className="mb-3">
        ...
        {businessUsers.length === 0 ? (
          ...
          <div className="block md:hidden space-y-4 max-w-4xl mx-auto">
            {businessUsers.map(user => (
              <div
                key={user.id}
                className="backdrop-blur-3xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl ring-1 ring-white/20 hover:shadow-3xl hover:scale-105 transition-all duration-500 p-4 w-full max-w-full overflow-hidden"
              >
                <div className="mb-3">
                  <span className="text-sm font-medium text-white break-all whitespace-normal">
                    {user.email}
                  </span>
                </div>
                <div className="flex items-center mb-4">
                  {user.isDeleted ? (
                    <Badge
                      variant="destructive"
                      className="bg-destructive backdrop-blur-2xl border border-red-400/30 text-red-200 rounded-xl flex items-center gap-1 text-xs px-2 py-1 whitespace-nowrap"
                    >
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-secondary backdrop-blur-2xl border border-orange-400/30 text-orange-200 rounded-xl flex items-center gap-1 text-xs px-2 py-1 whitespace-nowrap"
                    >
                    ...
                    <Badge
                      variant="default"
                      className="bg-primary backdrop-blur-2xl border border-green-400/30 text-green-200 rounded-xl flex items-center gap-1 text-xs px-2 py-1 whitespace-nowrap"
                    >
