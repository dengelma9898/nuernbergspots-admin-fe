            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
              <Select value={statusFilter} onValueChange={v => setStatusFilter(v as any)}>
                ...
                <SelectContent className="backdrop-blur-3xl bg-white/10 border-white/20 text-white">
                  <SelectItem value="ALL" className="text-white hover:bg-white/20 cursor-pointer">
                    Alle
                  </SelectItem>
                  <SelectItem
                      ...
                      >
                        <CardHeader className="p-4 md:p-6">
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                            ...
                            <Badge
                              className={`${getStatusColor(poll.status)} px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap`}
                            >
                              {poll.status}
                            </Badge>
                          </div>
