                    ...
                    <TabsContent value="content" className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            updateSetting('content', 'horizontalMargin', value)
                          }
                          min={0.5}
                          max={5}
                          step={0.1}
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            updateSetting('content', 'contentStartMargin', value)
                          }
                          min={3}
                          max={8}
                          step={0.1}
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            updateSetting('content', 'contentPadding', value)
                          }
                          min={0}
                          max={3}
                          step={0.1}
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            updateSetting(
                              'date',
                              'fontWeight',
                              parseInt(value) as 400 | 500 | 600 | 700
                            )
                          }
                        >
                          <SelectTrigger className="bg-background border-2 border-foreground text-foreground hover:bg-accent hover:border-foreground/80 rounded-xl font-medium dark:bg-card dark:border-foreground dark:text-foreground">
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            updateSetting('content', 'dateBlockSpacing', value)
                          }
                          min={0}
                          max={8}
                          step={0.5}
                      ...
                      <div className="space-y-2">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]) =>
                            updateSetting('content', 'eventSpacing', value)
                          }
                          min={0}
                          max={8}
                          step={0.5}
