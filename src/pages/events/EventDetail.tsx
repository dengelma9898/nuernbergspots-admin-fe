              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[...Array(4)].map((_, index) => (
                    <Skeleton
                      key={index}
                      className="bg-white/10 backdrop-blur-xl h-48 w-full rounded-lg"
                    />
                  ))}
                </div>
              </CardContent>
          ...
          <Card className="backdrop-blur-3xl bg-gradient-to-br from-white/15 to-white/5 border-white/20 shadow-2xl rounded-2xl ring-1 ring-white/30">
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    ...
                    className="backdrop-blur-2xl bg-white/20 border-white/30 text-white"
                  >
                    {status.icon}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="ticketsNeeded" className="text-white/90">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <div className="space-y-1">
                  <Label htmlFor="isPromoted" className="text-white/90">
                    ...
                    {previewUrls.length > 0 && (
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        {previewUrls.map((url, index) => (
                          <div
                            key={index}
                            className="relative w-full aspect-square border border-white/20 rounded-lg overflow-hidden backdrop-blur-2xl bg-white/5"
                          >
                            <img
                              src={url}
