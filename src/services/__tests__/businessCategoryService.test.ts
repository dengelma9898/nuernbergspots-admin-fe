...
describe('Business Category Service', () => {
  ...
  describe('getCategories', () => {
    it('should fetch all business categories with keywords', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/with-keywords');
  ...
  describe('getCategory', () => {
    it('should fetch a specific business category', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/1');
  ...
  describe('createCategory', () => {
    it('should create a new business category', async () => {
      ...
      expect(mockApi.postData).toHaveBeenCalledWith('/business-categories', categoryData);
  ...
  describe('updateCategory', () => {
    it('should update an existing business category', async () => {
      ...
      expect(mockApi.patchData).toHaveBeenCalledWith('/business-categories/1', updateData);
  ...
  describe('updateCategoryKeywords', () => {
    it('should update category keywords', async () => {
      ...
      mockApi.putData.mockResolvedValue(updatedCategory);

      const result = await businessCategoryService.updateCategoryKeywords('1', keywordIds);

      expect(mockApi.putData).toHaveBeenCalledWith('/business-categories/1/keywords', {
        keywordIds,
      });
      expect(result).toEqual(updatedCategory);
    });
  ...
  describe('searchCategories', () => {
    it('should search categories by query', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/search?q=restaurant');
      expect(result).toEqual(mockCategories);
    });
  ...
  describe('getCategoriesByIcon', () => {
    it('should fetch categories by icon name', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/icon/restaurant');
      expect(result).toEqual(mockCategories);
    });
    ...
    it('should properly encode icon name', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/icon/caf%C3%A9-shop');
    });
  });
  ...
  describe('error handling', () => {
    ...
    it('should handle keyword update errors', async () => {
      mockApi.putData.mockRejectedValue(new Error('Keyword update failed'));
  ...
  describe('edge cases', () => {
    ...
    it('should handle empty search query', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/search?q=');
    });
    ...
    it('should handle unicode characters in icon name', async () => {
      ...
      expect(mockApi.getData).toHaveBeenCalledWith('/business-categories/icon/caf%C3%A9');
    });
  });
});
